    ...
    <section class="ftco-section contact-section bg-light">
        <div class="container">
         ...
         <div class="row d-flex mb-5 contact-info">
            ...
            <div class="col-md-3 d-flex">
                <div class="info bg-white p-4">
                    <p><span>Phone:</span> <a href="tel://1234567920">{{ $item->mobile}}</a></p>
                </div>
            </div>
            <div class="col-md-3 d-flex">
                <div class="info bg-white p-4">
                    <p><span>Email:</span> <a href="mailto:info@yoursite.com">{{ $item->email}}</a></p>
                </div>
            </div>
            <div class="col-md-3 d-flex">
                <div class="info bg-white p-4">
                    <p><span>Website</span> <a href="#">{{ $item->website}}</a></p>
                </div>
            </div>
        </div>
         @endforeach
    ...
    <section class="ftco-gallery ftco-section ftco-no-pb">
        ...
        <div class="container-fluid px-0">
            <div class="row no-gutters">
                ...
                <div class="col-md-4 col-lg-2 ftco-animate">
                    <a href="{{ asset('cms/images/gallery-2.jpg')}}" class="gallery image-popup img d-flex align-items-center"
