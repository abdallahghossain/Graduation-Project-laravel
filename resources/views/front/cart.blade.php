                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <form action="{{ route('carts.destroy', $item->id) }}" method="POST">
                                            @method('delete')
                                            @csrf
                                            <button type="submit" class="product-remove" style="width: 20px;height: 15px;"><span class="ion-ios-close"></span></button>
                                        </form>
                                    </td>
                                    <td class="image-prod">
                                        <img class="img-fluid" style="width: 150px; height: 150px;" src="{{ asset('images/product/'.$item->product->image)}}" alt="">
                                    </td>

                                    <td class="product-name">
                                        <h3><a href="{{route('products.show',$item->product->id)}}"> {{ $item->product->name }}</a></h3>
