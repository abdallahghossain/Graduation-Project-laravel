            ...
            <div class="card-body pt-5">
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        <!--begin::Label-->
                        <label class="fs-6 fw-semibold form-label mt-3">
                            <span class="required">{{__('Category Id')}}</span>
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                aria-label="Enter the contact's name." data-bs-original-title="Enter the contact's name."
                                data-kt-initialized="1"></i>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" class="form-control form-control-solid" name="category_id" id="category_id"
                        ...
                        <div class="col">
                            ...
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                ...
                                <input type="number" name="price" id="price"
                                    class="form-control form-control-solid" value="{{ old('price') ?? $product->price }}">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                    ...
                    <div class="form-check form-check-custom form-check-solid form-check-primary">
                        <label for="status" class="form">{{__('Status')}}</label>
