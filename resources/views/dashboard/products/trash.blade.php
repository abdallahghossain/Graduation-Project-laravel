            ...
            <div class="card-body py-3">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <span>
                                <a href="{{ route('products.index') }}" class="btn btn-outline-info btn-sm ml-4 mb-3">{{__('back')}}</a>
                            </span>
                            <tr class="fw-bolder text-muted">
                                ...
                                <th class="min-w-150px">{{__('Compare Price')}} </th>
                            ...
                            @forelse ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="#"
                                                class="text-dark fw-bolder text-hover-primary fs-6">{{ $product->description }}</a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-start flex-column">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="#"
                                                class="text-dark fw-bolder text-hover-primary fs-6">${{ $product->compare_price }}</a>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-start flex-column">
